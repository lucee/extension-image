...
package org.lucee.extension.image.filter;import java.awt.BasicStroke;
...
//		int[] inPixels = getRGB( src, 0, 0, width, height, null );
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=src;//ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("AngleVariation")))!=null)setAngleVariation(ImageFilterUtil.toFloatValue(o,"AngleVariation"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Length")))!=null)setLength(ImageFilterUtil.toFloatValue(o,"Length"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Seed")))!=null)setSeed(ImageFilterUtil.toIntValue(o,"Seed"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Color")))!=null)setColor(ImageFilterUtil.toColorRGB(o,"Color"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Width")))!=null)setWidth(ImageFilterUtil.toFloatValue(o,"Width"));
