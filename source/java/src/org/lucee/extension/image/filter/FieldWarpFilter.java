...
public class FieldWarpFilter extends TransformFilter  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Power")))!=null)setPower(ImageFilterUtil.toFloatValue(o,"Power"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Strength")))!=null)setStrength(ImageFilterUtil.toFloatValue(o,"Strength"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("InLines")))!=null)setInLines(ImageFilterUtil.toAFieldWarpFilter$Line(o,"InLines"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("OutLines")))!=null)setOutLines(ImageFilterUtil.toAFieldWarpFilter$Line(o,"OutLines"));
