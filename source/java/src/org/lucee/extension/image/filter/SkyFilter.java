...
package org.lucee.extension.image.filter;import java.awt.Graphics2D;
...
*/
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Operation")))!=null)setOperation(ImageFilterUtil.toIntValue(o,"Operation"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Octaves")))!=null)setOctaves(ImageFilterUtil.toFloatValue(o,"Octaves"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("H")))!=null)setH(ImageFilterUtil.toFloatValue(o,"H"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Lacunarity")))!=null)setLacunarity(ImageFilterUtil.toFloatValue(o,"Lacunarity"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Gain")))!=null)setGain(ImageFilterUtil.toFloatValue(o,"Gain"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Bias")))!=null)setBias(ImageFilterUtil.toFloatValue(o,"Bias"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("T")))!=null)setT(ImageFilterUtil.toFloatValue(o,"T"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("FOV")))!=null)setFOV(ImageFilterUtil.toFloatValue(o,"FOV"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("CloudCover")))!=null)setCloudCover(ImageFilterUtil.toFloatValue(o,"CloudCover"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("CloudSharpness")))!=null)setCloudSharpness(ImageFilterUtil.toFloatValue(o,"CloudSharpness"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Glow")))!=null)setGlow(ImageFilterUtil.toFloatValue(o,"Glow"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("GlowFalloff")))!=null)setGlowFalloff(ImageFilterUtil.toFloatValue(o,"GlowFalloff"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Haziness")))!=null)setHaziness(ImageFilterUtil.toFloatValue(o,"Haziness"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("SunElevation")))!=null)setSunElevation(ImageFilterUtil.toFloatValue(o,"SunElevation"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("SunAzimuth")))!=null)setSunAzimuth(ImageFilterUtil.toFloatValue(o,"SunAzimuth"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("SunColor")))!=null)setSunColor(ImageFilterUtil.toColorRGB(o,"SunColor"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("CameraElevation")))!=null)setCameraElevation(ImageFilterUtil.toFloatValue(o,"CameraElevation"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("CameraAzimuth")))!=null)setCameraAzimuth(ImageFilterUtil.toFloatValue(o,"CameraAzimuth"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("WindSpeed")))!=null)setWindSpeed(ImageFilterUtil.toFloatValue(o,"WindSpeed"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Time")))!=null)setTime(ImageFilterUtil.toFloatValue(o,"Time"));
