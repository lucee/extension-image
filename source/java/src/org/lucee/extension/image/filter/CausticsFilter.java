...
public class CausticsFilter extends WholeImageFilter  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Brightness")))!=null)setBrightness(ImageFilterUtil.toIntValue(o,"Brightness"));
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Dispersion")))!=null)setDispersion(ImageFilterUtil.toFloatValue(o,"Dispersion"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("BgColor")))!=null)setBgColor(ImageFilterUtil.toColorRGB(o,"BgColor"));
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Samples")))!=null)setSamples(ImageFilterUtil.toIntValue(o,"Samples"));
