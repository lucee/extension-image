...
public class ScaleFilter extends AbstractBufferedImageOp  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		int width=eng.getCastUtil().toIntValue(parameters.get(eng.getCreationUtil().createKey("Width")));
		int height=eng.getCastUtil().toIntValue(parameters.get(eng.getCreationUtil().createKey("Height")));
		setHeight(height);
		setWidth(width);
