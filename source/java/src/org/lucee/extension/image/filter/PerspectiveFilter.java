...
package org.lucee.extension.image.filter;import java.awt.Rectangle;
...
*/
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("xlt")))!=null)setXLT(ImageFilterUtil.toFloatValue(o,"xlt"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("ylt")))!=null)setYLT(ImageFilterUtil.toFloatValue(o,"ylt"));
		
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("xrt")))!=null)setXRT(ImageFilterUtil.toFloatValue(o,"xrt"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("yrt")))!=null)setYRT(ImageFilterUtil.toFloatValue(o,"yrt"));
		
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("xrb")))!=null)setXRB(ImageFilterUtil.toFloatValue(o,"xrb"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("yrb")))!=null)setYRB(ImageFilterUtil.toFloatValue(o,"yrb"));
		
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("xlb")))!=null)setXLB(ImageFilterUtil.toFloatValue(o,"xlb"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("ylb")))!=null)setYLB(ImageFilterUtil.toFloatValue(o,"ylb"));
		...
		if(parameters.size()>0) {
			throw eng.getExceptionUtil().createFunctionException(eng.getThreadPageContext(), "ImageFilter", 3, "parameters", "the parameter"+(parameters.size()>1?"s":"")+" ["+eng.getListUtil().toList(parameters.keys(),", ")+"] "+(parameters.size()>1?"are":"is")+" not allowed, only the following parameters are supported [Corners, EdgeAction, Interpolation]",null);
		}
