...
*/
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Resize")))!=null)setResize(ImageFilterUtil.toBooleanValue(o,"Resize"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("XAngle")))!=null)setXAngle(ImageFilterUtil.toFloatValue(o,"XAngle"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("YAngle")))!=null)setYAngle(ImageFilterUtil.toFloatValue(o,"YAngle"));
