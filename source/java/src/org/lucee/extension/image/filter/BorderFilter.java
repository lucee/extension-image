...
public class BorderFilter extends AbstractBufferedImageOp  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Left")))!=null)setLeft(ImageFilterUtil.toIntValue(o,"Left"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Right")))!=null)setRight(ImageFilterUtil.toIntValue(o,"Right"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Top")))!=null)setTop(ImageFilterUtil.toIntValue(o,"Top"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Bottom")))!=null)setBottom(ImageFilterUtil.toIntValue(o,"Bottom"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Color")))!=null)setColor(ImageFilterUtil.toColor(o,"Color"));
