...
public class ThresholdFilter extends PointFilter  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("White")))!=null)setWhite(ImageFilterUtil.toColorRGB(o,"White"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Black")))!=null)setBlack(ImageFilterUtil.toColorRGB(o,"Black"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("LowerThreshold")))!=null)setLowerThreshold(ImageFilterUtil.toIntValue(o,"LowerThreshold"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("UpperThreshold")))!=null)setUpperThreshold(ImageFilterUtil.toIntValue(o,"UpperThreshold"));
