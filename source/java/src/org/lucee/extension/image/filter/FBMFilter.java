...
public class FBMFilter extends PointFilter implements Cloneable, DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("BasisType")))!=null)setBasisType(ImageFilterUtil.toIntValue(o,"BasisType"));
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Basis")))!=null)setBasis(ImageFilterUtil.toFunction2D(o,"Basis"));
