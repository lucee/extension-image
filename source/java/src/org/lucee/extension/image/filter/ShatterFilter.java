...
//			g.translate( -tile.w*0.5f, -tile.h*0.5f );
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Iterations")))!=null)setIterations(ImageFilterUtil.toIntValue(o,"Iterations"));
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Transition")))!=null)setTransition(ImageFilterUtil.toFloatValue(o,"Transition"));
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("StartAlpha")))!=null)setStartAlpha(ImageFilterUtil.toFloatValue(o,"StartAlpha"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("EndAlpha")))!=null)setEndAlpha(ImageFilterUtil.toFloatValue(o,"EndAlpha"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Tile")))!=null)setTile(ImageFilterUtil.toIntValue(o,"Tile"));

		// check for arguments not supported
		if(parameters.size()>0) {
			throw eng.getExceptionUtil().createFunctionException(eng.getThreadPageContext(), "ImageFilter", 3, "parameters", "the parameter"+(parameters.size()>1?"s":"")+" ["+eng.getListUtil().toList(parameters.keys(),", ")+"] "+(parameters.size()>1?"are":"is")+" not allowed, only the following parameters are supported [Iterations, CentreX, CentreY, Centre, Transition, Distance, Rotation, Zoom, StartAlpha, EndAlpha, Tile]",null);
		}
