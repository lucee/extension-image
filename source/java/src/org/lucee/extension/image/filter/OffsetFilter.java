...
public class OffsetFilter extends TransformFilter  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("XOffset")))!=null)setXOffset(ImageFilterUtil.toIntValue(o,"XOffset"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("YOffset")))!=null)setYOffset(ImageFilterUtil.toIntValue(o,"YOffset"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Wrap")))!=null)setWrap(ImageFilterUtil.toBooleanValue(o,"Wrap"));
