...
public class GlintFilter extends AbstractBufferedImageOp  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Blur")))!=null)setBlur(ImageFilterUtil.toFloatValue(o,"Blur"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("GlintOnly")))!=null)setGlintOnly(ImageFilterUtil.toBooleanValue(o,"GlintOnly"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Length")))!=null)setLength(ImageFilterUtil.toIntValue(o,"Length"));
