...
public class FourColorFilter extends PointFilter  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("ColorNW")))!=null)setColorNW(ImageFilterUtil.toIntValue(o,"ColorNW"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("ColorNE")))!=null)setColorNE(ImageFilterUtil.toIntValue(o,"ColorNE"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("ColorSW")))!=null)setColorSW(ImageFilterUtil.toIntValue(o,"ColorSW"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("ColorSE")))!=null)setColorSE(ImageFilterUtil.toIntValue(o,"ColorSE"));
