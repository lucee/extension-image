...
public class ChannelMixFilter extends PointFilter  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("BlueGreen")))!=null)setBlueGreen(ImageFilterUtil.toIntValue(o,"BlueGreen"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("RedBlue")))!=null)setRedBlue(ImageFilterUtil.toIntValue(o,"RedBlue"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("GreenRed")))!=null)setGreenRed(ImageFilterUtil.toIntValue(o,"GreenRed"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("IntoR")))!=null)setIntoR(ImageFilterUtil.toIntValue(o,"IntoR"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("IntoG")))!=null)setIntoG(ImageFilterUtil.toIntValue(o,"IntoG"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("IntoB")))!=null)setIntoB(ImageFilterUtil.toIntValue(o,"IntoB"));
