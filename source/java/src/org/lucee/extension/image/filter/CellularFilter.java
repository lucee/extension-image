...
public class CellularFilter extends WholeImageFilter implements Function2D, Cloneable, DynFiltering {
	 ...
	 * -  TRIANGULAR
	 */
	public void setGridType(String gridType) throws PageException {
		...
		if("random".equals(gridType)) this.gridType = RANDOM;
			...
			throw CFMLEngineFactory.getInstance().getExceptionUtil().createExpressionException(
					"invalid value ["+gridType+"] for gridType, valid values are [random,square,hexagonal,octagonal,triangular]");
	}
