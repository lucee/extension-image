...
package org.lucee.extension.image.filter;import java.awt.AlphaComposite;
...
import org.lucee.extension.image.composite.MiscComposite;
...
public class RaysFilter extends MotionBlurOp  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Strength")))!=null)setStrength(ImageFilterUtil.toFloatValue(o,"Strength"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Opacity")))!=null)setOpacity(ImageFilterUtil.toFloatValue(o,"Opacity"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("RaysOnly")))!=null)setRaysOnly(ImageFilterUtil.toBooleanValue(o,"RaysOnly"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Threshold")))!=null)setThreshold(ImageFilterUtil.toFloatValue(o,"Threshold"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Angle")))!=null)setAngle(ImageFilterUtil.toFloatValue(o,"Angle"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("CentreX")))!=null)setCentreX(ImageFilterUtil.toFloatValue(o,"CentreX"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("CentreY")))!=null)setCentreY(ImageFilterUtil.toFloatValue(o,"CentreY"));
		//if((o=parameters.removeEL(eng.getCreationUtil().createKey("Centre")))!=null)setCentre(ImageFilterUtil.toPoint2D(o,"Centre"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Distance")))!=null)setDistance(ImageFilterUtil.toFloatValue(o,"Distance"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Rotation")))!=null)setRotation(ImageFilterUtil.toFloatValue(o,"Rotation"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Zoom")))!=null)setZoom(ImageFilterUtil.toFloatValue(o,"Zoom"));

		// check for arguments not supported
		if(parameters.size()>0) {
			throw eng.getExceptionUtil().createFunctionException(eng.getThreadPageContext(), "ImageFilter", 3, "parameters", "the parameter"+(parameters.size()>1?"s":"")+" ["+eng.getListUtil().toList(parameters.keys(),", ")+"] "+(parameters.size()>1?"are":"is")+" not allowed, only the following parameters are supported [Colormap, Strength, Opacity, RaysOnly, Threshold, Angle, CentreX, CentreY, Centre, Distance, Rotation, Zoom]",null);
		}
