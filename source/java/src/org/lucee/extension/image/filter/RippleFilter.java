...
public class RippleFilter extends TransformFilter  implements DynFiltering {
     ...
     * @see #getWaveType
	 */
	public void setWaveType(String waveType) throws PageException {
		...
		if("SINE".equals(str)) this.waveType = SINE;
			...
			throw CFMLEngineFactory.getInstance().getExceptionUtil().createExpressionException("invalid value ["+waveType+"] for waveType, valid values are [sine,sawtooth,triangle,noise]");
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("XAmplitude")))!=null)setXAmplitude(ImageFilterUtil.toFloatValue(o,"XAmplitude"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("XWavelength")))!=null)setXWavelength(ImageFilterUtil.toFloatValue(o,"XWavelength"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("YAmplitude")))!=null)setYAmplitude(ImageFilterUtil.toFloatValue(o,"YAmplitude"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("YWavelength")))!=null)setYWavelength(ImageFilterUtil.toFloatValue(o,"YWavelength"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("WaveType")))!=null)setWaveType(ImageFilterUtil.toString(o,"WaveType"));
