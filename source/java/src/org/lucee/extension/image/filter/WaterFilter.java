...
package org.lucee.extension.image.filter;import java.awt.geom.Point2D;
...
public class WaterFilter extends TransformFilter  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=null;//ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Wavelength")))!=null)setWavelength(ImageFilterUtil.toFloatValue(o,"Wavelength"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Amplitude")))!=null)setAmplitude(ImageFilterUtil.toFloatValue(o,"Amplitude"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Phase")))!=null)setPhase(ImageFilterUtil.toFloatValue(o,"Phase"));
