...
public class CheckFilter extends PointFilter  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("XScale")))!=null)setXScale(ImageFilterUtil.toIntValue(o,"XScale"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("YScale")))!=null)setYScale(ImageFilterUtil.toIntValue(o,"YScale"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Fuzziness")))!=null)setFuzziness(ImageFilterUtil.toIntValue(o,"Fuzziness"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Foreground")))!=null)setForeground(ImageFilterUtil.toColorRGB(o,"Foreground"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Background")))!=null)setBackground(ImageFilterUtil.toColorRGB(o,"Background"));
