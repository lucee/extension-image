...
public class PlasmaFilter extends WholeImageFilter  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Scaling")))!=null)setScaling(ImageFilterUtil.toFloatValue(o,"Scaling"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("UseColormap")))!=null)setUseColormap(ImageFilterUtil.toBooleanValue(o,"UseColormap"));
