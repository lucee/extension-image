...
public class MarbleFilter extends TransformFilter  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=null;//ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("XScale")))!=null)setXScale(ImageFilterUtil.toFloatValue(o,"XScale"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("YScale")))!=null)setYScale(ImageFilterUtil.toFloatValue(o,"YScale"));
