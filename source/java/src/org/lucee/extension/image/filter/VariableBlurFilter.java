...
public class VariableBlurFilter extends AbstractBufferedImageOp  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("HRadius")))!=null)setHRadius(ImageFilterUtil.toIntValue(o,"HRadius"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("VRadius")))!=null)setVRadius(ImageFilterUtil.toIntValue(o,"VRadius"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Radius")))!=null)setRadius(ImageFilterUtil.toIntValue(o,"Radius"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("BlurMask")))!=null)setBlurMask(ImageFilterUtil.toBufferedImage(o,"BlurMask"));

		// check for arguments not supported
		if(parameters.size()>0) {
			throw CFMLEngineFactory.getInstance().getExceptionUtil().createFunctionException(eng.getThreadPageContext(), "ImageFilter", 3, "parameters", "the parameter"+(parameters.size()>1?"s":"")+" ["+eng.getListUtil().toList(parameters.keys(),", ")+"] "+(parameters.size()>1?"are":"is")+" not allowed, only the following parameters are supported [PremultiplyAlpha, Iterations, HRadius, VRadius, Radius, BlurMask]",null);
		}
