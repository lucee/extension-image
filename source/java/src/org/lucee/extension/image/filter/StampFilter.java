...
public class StampFilter extends PointFilter  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("White")))!=null)setWhite(ImageFilterUtil.toColor(o,"White"));
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Black")))!=null)setBlack(ImageFilterUtil.toColor(o,"Black"));
