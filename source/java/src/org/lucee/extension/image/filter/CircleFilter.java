...
public class CircleFilter extends TransformFilter  implements DynFiltering {
	...
	public BufferedImage filter(BufferedImage src, Struct parameters) throws PageException {BufferedImage dst=null;//ImageUtil.createBufferedImage(src);
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("SpreadAngle")))!=null)setSpreadAngle(ImageFilterUtil.toFloatValue(o,"SpreadAngle"));
		...
		if((o=parameters.removeEL(eng.getCreationUtil().createKey("Height")))!=null)setHeight(ImageFilterUtil.toFloatValue(o,"Height"));
