...
public class ImageDrawRect extends FunctionSupport {
	...
	public static String call(PageContext pc, Object name, double x, double y, double width,double height, boolean filled) throws PageException {
		...
		if (width < 0)
		    ...
		    .createFunctionException(pc,"ImageDrawRect",3,"width","width must contain a none negative value",null);
		if (height < 0)
		    throw CFMLEngineFactory.getInstance().getExceptionUtil()
		    .createFunctionException(pc,"ImageDrawRect",4,"height","width must contain a none negative value",null);
	...
	public Object invoke(PageContext pc, Object[] args) throws PageException {
		...
		throw exp.createFunctionException(pc, "ImageDrawRect", 5, 6, args.length);
	}
}