...
public class ImageDrawArc extends FunctionSupport {
	...
	public static String call(PageContext pc, Object name, double x, double y, double width, double height
		...
		if (width < 0)
		    ...
		    .createFunctionException(pc,"ImageDrawArc",3,"width","width must contain a none negative value",null);
		if (height < 0)
		    throw CFMLEngineFactory.getInstance().getExceptionUtil()
		    .createFunctionException(pc,"ImageDrawArc",4,"height","width must contain a none negative value",null);
	...
	public Object invoke(PageContext pc, Object[] args) throws PageException {
		if(args.length==8) return call(pc, args[0],cast.toDoubleValue(args[1]),cast.toDoubleValue(args[2]),cast.toDoubleValue(args[3])
				,cast.toDoubleValue(args[4]),cast.toDoubleValue(args[5]),cast.toDoubleValue(args[6]),cast.toBooleanValue(args[7]));
		...
		throw exp.createFunctionException(pc, "ImageDrawArc", 7, 8, args.length);
	}
