...
public class ImageCrop extends FunctionSupport {
	...
	public static String call(PageContext pc, Object name, double x, double y, double width, double height) throws PageException {
		...
		if (width < 0)
		    ...
		    .createFunctionException(pc,"ImageCrop",3,"width","width must contain a none negative value",null);
		if (height < 0)
		    throw CFMLEngineFactory.getInstance().getExceptionUtil()
		    .createFunctionException(pc,"ImageCrop",4,"height","width must contain a none negative value",null);
