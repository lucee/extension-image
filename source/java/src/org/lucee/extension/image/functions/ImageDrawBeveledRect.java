...
public class ImageDrawBeveledRect extends FunctionSupport {
	...
	public static String call(PageContext pc, Object name, double x, double y, double width, double height, boolean raised , boolean filled) throws PageException {
		...
		if (width < 0)
		    ...
		    .createFunctionException(pc,"ImageDrawBeveledRect",3,"width","width must contain a none negative value",null);
		if (height < 0)
		    throw CFMLEngineFactory.getInstance().getExceptionUtil()
		    .createFunctionException(pc,"ImageDrawBeveledRect",4,"height","width must contain a none negative value",null);
	...
	public Object invoke(PageContext pc, Object[] args) throws PageException {
		if(args.length==7) return call(pc, args[0],cast.toDoubleValue(args[1]),cast.toDoubleValue(args[2]),cast.toDoubleValue(args[3]),cast.toDoubleValue(args[4]),cast.toBooleanValue(args[5]),cast.toBooleanValue(args[6]));
		...
		throw exp.createFunctionException(pc, "ImageDrawBeveledRect", 5, 7, args.length);
	}
